...
const ConfigFiles = lazy(() => import('./instance-detail/ConfigFiles'));
const WorldGen = lazy(() => import('./instance-detail/WorldGen'));
const Mods = lazy(() => import('./instance-detail/Mods'));
const Saves = lazy(() => import('./instance-detail/Saves'));
const Players = lazy(() => import('./instance-detail/Players'));
const ChatLogs = lazy(() => import('./instance-detail/ChatLogs'));
const UpdateCheck = lazy(() => import('./instance-detail/UpdateCheck'));
const LogFiles = lazy(() => import('./instance-detail/LogFiles'));
const Admins = lazy(() => import('./instance-detail/Admins'));
const InstanceRoles = lazy(() => import('./instance-detail/InstanceRoles'));
const GameCommandHelp = lazy(() => import('./instance-detail/GameCommandHelp'));
...
export default function ServerDetail({
  ...
  // 自定义日期 → 计算天数
  const submitCustomExpiry = () => {
    if (!expiryCustomDate) {
      toast.error('请选择到期日期');
      return;
    }
    const targetDate = new Date(expiryCustomDate);
    ...
    <div className={`page${isStoreView ? ' server-detail-store-embedded' : ''}`}>
      ...
      {showExpiryEdit && (
        <div
          ...
          onClick={() => setShowExpiryEdit(false)}
        >
          <div
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                ...
                <button
                  ...
                  onClick={submitCustomExpiry}
                  disabled={updateExpiryMutation.isPending || !expiryCustomDate}
                >
                  提交
                </button>
              </div>
